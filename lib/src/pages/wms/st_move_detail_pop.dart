...
class StMoveDetailPop extends StatefulWidget {
  final dynamic item; // You can change the type of item as needed
  final String refVal1;

  const StMoveDetailPop({super.key, required this.item, required this.refVal1});

  @override
  State<StMoveDetailPop> createState() => _StMoveDetailPopState();
}

class _StMoveDetailPopState extends State<StMoveDetailPop> {
  String getRefVal1() {
              ...
              const SizedBox(height: 10,),
                ...
                children: [
                  ...
                  onPressed: () {
                    ...
                    MaterialPageRoute(builder: (context) => StMoveFindLocPop(refVal1: getRefVal1(),))
                    ).then((result) {
                    if (result != null) {
                      setState(() {
